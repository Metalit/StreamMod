...
function createBaseSettings(): Settings {
  return { horizontal: 0, vertical: 0, bitrate: 0, fps: 0, fov: 0, mic: false, smoothness: 0 };
}
...
export const PacketWrapper: MessageFns<PacketWrapper> = {
  ...
  fromPartial<I extends Exact<DeepPartial<PacketWrapper>, I>>(object: I): PacketWrapper {
    ...
    if (object.Packet?.$case === "videoFrame" && object.Packet?.value !== undefined && object.Packet?.value !== null) {
      message.Packet = { $case: "videoFrame", value: VideoFrame.fromPartial(object.Packet.value) };
    }
    if (object.Packet?.$case === "audioFrame" && object.Packet?.value !== undefined && object.Packet?.value !== null) {
